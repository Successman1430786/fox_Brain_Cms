...
Requirements blueprint has been drafted.

Before Phase 1 implementation begins, maintain these two control documents:
- `brain.md` — permanent project rules and architecture memory
- `info.md` — FoxBrain-specific confirmed information, requirements and placeholders
